# GitVibeDev Documentation

> Documentation version: **v0.2.0**
>
> Applies to backend API version `0.2.0` (`backend/app/main.py`).

This documentation set is written for first-time contributors and self-hosters.
All command blocks are copy-paste ready.
